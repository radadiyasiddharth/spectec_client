...
//       <h2 className="text-2xl font-semibold mb-6 text-gray-100">Users</h2>
//       {users.length === 0 ? (
...
//               <tr>
//                 <th className="py-3 px-6 border-b font-semibold">Username</th>
//                 <th className="py-3 px-6 border-b font-semibold">Email</th>
//                 <th className="py-3 px-6 border-b font-semibold">Role</th>
//                 <th className="py-3 px-6 border-b font-semibold">Created At</th>
...
//                       className="border border-gray-300 rounded-lg p-1 text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
//                     >
...
//                     <button
//                       className="text-red-500 hover:text-red-700 transition-colors duration-200 text-xs md:text-sm"
